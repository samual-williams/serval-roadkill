...
# now find most common traffic volum at sampling points for each section
library(data.table)
...
library(GISTools)
poly.counts(guineafowl, bufferWGS84) -> res # Count number of infrastructure points within each 10km section of buffer & store as res
...
library(GISTools)
res <- poly.counts(owls, bufferWGS84) # Count number of infrastructure points within each 10km section of buffer & store as res
